#ifndef __ACCUMULATEFP16SINGLE_H__
#define __ACCUMULATEFP16SINGLE_H__
#include <mv_types.h>
...
void mvcvAccumulateFp16Single64_asm(half* dst, half bias, u32 width);
//!@}


#endif //__ACCUMULATEFP16SINGLE_H__