...
mvcvMaxPool3x3s2hh_asm:
    ...
    lsu0.ld.32 i17 i17   || lsu1.ldil i6 ___maxPool3x3s2hh_compensate
    lsu0.ldih i6 ___maxPool3x3s2hh_compensate
    nop 2
...
// τα i0, i1, i2 δείχνουν στα επόμενα δεδομένα των αντίστοιχων γραμμών.
    ...
    iau.sub i4 i4 1
    cmu.cmz.i32 i4
    peu.pc1c eq || bru.bra ___maxPool3x3s2hh_compensate
