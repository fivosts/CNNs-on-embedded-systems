#ifndef __CONVOLUTION5x5U8fToFp16_H__
#define __CONVOLUTION5x5U8fToFp16_H__
#include <mv_types.h>
...
void mvcvConvolution5x5U8fToFp16_asm(half** in, half** out, half conv[25], u32 inWidth);
//!@}
